...
public class PageDTO {
	...
	private int firstPageRecordIndex;
	...
	public int getFirstPageRecordIndex() {
		firstPageRecordIndex = getTotalRecordCount() - (getCurrentPageNo() - 1) * getRecordCountPerPage();
		return firstPageRecordIndex;
	}
