...
<div class="mt-2 pt-2 codeList">
	<div class="container-fluid px-4">
		<div class="card my-2">
			...
			<div class="tabPage d-none card-body p-3 d-flex flex-row justify-content-between">
				<div class="card col-6">
					<div class="card-header d-flex flex-row justify-content-between">
						<h4>공통 코드</h4>
						<button class="btn btn-success" onclick="showInsertModal()">추가하기</button>
					</div>
					<div class="tree-body card-body">
					...
					<div class="card-footer flex-row d-flex justify-content-end">
						<button class="btn rounded-pill btn-outline-danger" onclick="deleteTreeCode()">선택삭제</button>
					</div>
				</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".tree-body li").on("click", function(e) {
			...
			$(document).on("input", ".editable.bg-light", (e) => {
